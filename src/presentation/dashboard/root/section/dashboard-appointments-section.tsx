...
const DashboardAppointmentsSection = () => {
	...
	const filteredAppointments = useMemo(() => {
		if (!dashboardInfo.activeAppointments) return [];

		const normalizedSearchTerm = searchTerm.replace('#', '').toLowerCase();

		return (dashboardInfo.activeAppointments ?? []).filter(
	...
	}, [dashboardInfo.activeAppointments, searchTerm]);
...
export default DashboardAppointmentsSection;
